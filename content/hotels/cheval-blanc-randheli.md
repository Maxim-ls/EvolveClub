...
facts:
  ...
  - label: "Телефон"
    text: "+960 656 1515"
  - label: "Трансфер"
    text: "около 40 минут на гидросамолете от Velana"
  - label: "Формат"
    text: "46 вилл и резиденций с приватными бассейнами"
rooms_title: "Варианты вилл"
rooms_intro: "Виллы Cheval Blanc Randheli расположены на пляже, над водой и в формате garden water - с приватным садом и террасой над лагуной. Во всех категориях есть собственный бассейн, просторные наружные зоны, гостиная, большая ванная комната, душ в помещении и на открытом воздухе, гардеробная зона, Wi-Fi, мини-бар, чайная и кофейная станция, сейф и персональный сервис Majordome."
rooms:
  - title: "Островные виллы"
    type: "240-300 м²"
...
sections:
  ...
  - title: "Пляж и бассейны"
    body: "Виллы распределены между пляжем, лагуной и водной линией, поэтому гости выбирают нужный баланс: песок и зелень, открытая вода или более закрытая терраса. В каждой вилле есть собственный бассейн, а пляжный ритм остается камерным и спокойным."
  - title: "SPA и восстановление"
    body: "Spa Cheval Blanc расположен на отдельном острове и воспринимается как самостоятельная часть поездки. Здесь уместны не только разовые процедуры, но и несколько дней восстановления: массажи, уходы, йога, медитативный ритм и приватные wellness-сценарии."
  - title: "Спорт и досуг"
    body: "Дни можно строить вокруг Spa Cheval Blanc, дайвинга, снорклинга, водного спорта, йоги, фитнеса, морских прогулок и ужинов на пляже. Для детей работает Le Carrousel с творческими и спортивными программами."
  - title: "Для детей"
    body: "Le Carrousel помогает встроить детский отдых в общий ритм семьи: творческие занятия, игры, спорт и спокойные активности на острове. Формат подходит семьям, которым нужен деликатный сервис без ощущения массового детского клуба."
  - title: "Кому подойдет"
    body: "Cheval Blanc Randheli подойдет тем, кто ищет тихий, очень эстетичный курорт без лишнего движения: пары, семьи, гости с высоким запросом к сервису и те, кому важны приватность, гастрономия и ощущение личного островного дома."
order: 2
published: true
featured: true
tags: hotel
